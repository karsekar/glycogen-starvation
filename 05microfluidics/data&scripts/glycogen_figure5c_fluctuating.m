%% Figure 5C - fluctuating nutrient
%
%  code for final manuscript figures from microfluidic visualizations

%       input:  all three experimental replicates with YFP wt and CFP mutant,
...
% commit: final figure of fluctuating data for manuscript
