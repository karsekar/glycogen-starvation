%% Figure 5C - steady nutrient
%
%  code for final manuscript figures from microfluidic visualizations

%       input:  both experimental replicates with YFP wt and CFP mutant,
%               matlab data files named by date experiment was performed
...
% Note: major difference from "fluctuating" version of this script is the time
...
% last update: Jen Nguyen, 2019 November 18
% commit: final figure of steady data for manuscript
